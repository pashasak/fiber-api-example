...
func (q *BookQueries) GetBooks() ([]Book, error) {
...
func (q *BookQueries) GetBook(id uuid.UUID) (Book, error) {
...
func (q *BookQueries) CreateBook(b *Book) error {
	// Define query string.
...
func (q *BookQueries) UpdateBook(id uuid.UUID, b *Book) error {
	// Define query string.
