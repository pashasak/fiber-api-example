...
import (
	...
	"fiber-api-example/app/platform/database"
	"fiber-api-example/app/utils"
...
// NewBook func for creates a new book.
...
// @Param book_attrs body books.BookAttrs true "Book attributes"
// @Success 200 {object} books.Book
// @Security ApiKeyAuth
// @Router /v1/book [post]
